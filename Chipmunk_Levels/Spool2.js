...
Spool2.prototype.setNiceViewCenter = function (gameGraphics, canvas) {
    gameGraphics.PTM = 1000;
    setViewCenterWorld(gameGraphics, canvas, this.position, true);
}

Spool2.prototype.setup = function (gameState, gameGraphics) {
    ...
    shape1.draw = function (context) {
        ...
        drawLine(context, cp.v(0, -this.r / 2).add(this.tc), cp.v(0, -this.r / 2).add(this.tc).add(cp.v(-this.body.p.x / 2+8.5, 0)));
...
Spool2.prototype.step = function (gameState, gameDygraph, dataTimeStep, graphTimeStep) {
    var force = cp.v(2*gameState.stepTime / (500), 0);
    var r = cp.v(0, -this.radius / 2);
...
Spool2.prototype.initializeDygraph = function (gameState, gameDygraph, graphID) {
...
Spool2.prototype.updateCurrentParameters = function (t1, f1, f2, f3) {
...
Spool2.prototype.addToDygraph = function (gameState, gameDygraph, dataTimeStep, graphTimeStep, x, y, z) {
...
Spool2.prototype.updateInitialParameters = function () {

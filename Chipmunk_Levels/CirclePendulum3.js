//Level: Pendulum
var CirclePendulum3 = function () {
    this.maxDuration = 0.745;
};

CirclePendulum3.prototype.setNiceViewCenter = function (gameGraphics, canvas) {
    var point = { x: -0.01, y: 0.25 };
    gameGraphics.PTM = 580;
    setViewCenterWorld(gameGraphics, canvas, point, true);
}

CirclePendulum3.prototype.setup = function (gameState, gameGraphics) {
...
CirclePendulum3.prototype.step = function (gameState, gameDygraph, dataTimeStep, graphTimeStep) {
...
CirclePendulum3.prototype.initializeDygraph = function (gameState, gameDygraph, graphID) {
...
CirclePendulum3.prototype.updateCurrentParameters = function (t1, h1, h2) {
...
CirclePendulum3.prototype.addToDygraph = function (gameState, gameDygraph, dataTimeStep, graphTimeStep, x, y) {
...
CirclePendulum3.prototype.updateInitialParameters = function () {
    ...
    table.innerHTML =
        ...
        '<td>Mass</td>' +
        '<td id=\"mass-initial-1\">1.0 kg</td>' +
        '</tr>' +

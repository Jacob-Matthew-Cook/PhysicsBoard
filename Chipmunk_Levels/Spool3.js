...
Spool3.prototype.setNiceViewCenter = function (gameGraphics, canvas) {
    gameGraphics.PTM = 1000;
    setViewCenterWorld(gameGraphics, canvas, this.position, true);
}

Spool3.prototype.setup = function (gameState, gameGraphics) {
    var UNHITTABLE = 1 << 16;
    var SHAPES = 1 << 1;
    ...
    shape1.draw = function (context) {
        ...
        drawLine(context, cp.v(this.r / 2, 0).add(this.tc), cp.v(this.r / 2, 0).add(this.tc).add(cp.v(0, -this.body.p.x/2)));
...
Spool3.prototype.step = function (gameState, gameDygraph, dataTimeStep, graphTimeStep) {
...
Spool3.prototype.initializeDygraph = function (gameState, gameDygraph, graphID) {
...
Spool3.prototype.updateCurrentParameters = function (t1, f1, f2, f3) {
    var time = document.getElementById('running-time');
    var forceUp = document.getElementById('spool-down');
...
Spool3.prototype.addToDygraph = function (gameState, gameDygraph, dataTimeStep, graphTimeStep, x, y, z) {
...
Spool3.prototype.updateInitialParameters = function () {
    ...
    table.innerHTML =
        ...
        '<td id=\"length-initial-1\">Downwards</td>' +
        '</tr>' +
        //body1
        '<tr class=\'both-pendulums-init\'>' +
        '<td>Mass</td>' +

//Level: Pendulum
var Pulley1 = function () {
  this.maxDuration = 0.95;
};

Pulley1.prototype.setNiceViewCenter = function (gameGraphics, canvas) {
    var point = { x: 1, y: 1.2 };
    gameGraphics.PTM = 200;
    setViewCenterWorld(gameGraphics, canvas, point, true);
}

Pulley1.prototype.setup = function (gameState, gameGraphics) {
...
Pulley1.prototype.initializeDygraph = function (gameState, gameDygraph, graphID) {
...
Pulley1.prototype.updateCurrentParameters = function (t1, v1, v2, h1, h2) {
...
Pulley1.prototype.addToDygraph = function (gameState, gameDygraph, dataTimeStep, graphTimeStep, w, x, y, z) {

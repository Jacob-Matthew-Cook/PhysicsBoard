var RollingCylinder4 = function () {
    this.maxDuration = 2;
};

RollingCylinder4.prototype.setNiceViewCenter = function (gameGraphics, canvas) {
    gameGraphics.PTM = 500;
    var center = {x: 0.67, y: 0.25}
    setViewCenterWorld(gameGraphics, canvas, center, true);
}

RollingCylinder4.prototype.setup = function (gameState, gameGraphics) {
...
RollingCylinder4.prototype.step = function (gameState, gameDygraph, dataTimeStep, graphTimeStep) {
    if (this.block) {
...
RollingCylinder4.prototype.initializeDygraph = function (gameState, gameDygraph, graphID) {
...
RollingCylinder4.prototype.updateCurrentParameters = function (t1, w, x, y, z) {
...
RollingCylinder4.prototype.addToDygraph = function (gameState, gameDygraph, dataTimeStep, graphTimeStep, w, x, y, z) {
...
RollingCylinder4.prototype.updateInitialParameters = function () {

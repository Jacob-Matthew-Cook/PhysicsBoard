var Pulley3 = function () {
  this.maxDuration = 0.73;
};

Pulley3.prototype.setNiceViewCenter = function (gameGraphics, canvas) {
    var point = { x: 1, y: 1.2 };
    gameGraphics.PTM = 200;
    setViewCenterWorld(gameGraphics, canvas, point, true);
}

Pulley3.prototype.setup = function (gameState, gameGraphics) {
    ...
    var body1 = world.addBody(new cp.Body(mass1, cp.momentForPoly(mass1, verts, zr_pt)));
    body1.setPos(st_pt1);
    body1.setAngle(0);
    body1.w_limit = 1.5;

    var shape1 = gameState.shapeArray[0] = world.addShape(new cp.PolyShape(body1, verts, zr_pt));
    ...
    world.addConstraint(new cp.PulleyJoint2(body1, staticBody, body2, hook, rev_pt1, rev_pt2, hook));
...
Pulley3.prototype.step = function (gameState, gameDygraph, dataTimeStep, graphTimeStep) {
...
Pulley3.prototype.initializeDygraph = function (gameState, gameDygraph, graphID) {
...
Pulley3.prototype.updateCurrentParameters = function (t1, v1, v2, h1, h2) {
...
Pulley3.prototype.addToDygraph = function (gameState, gameDygraph, dataTimeStep, graphTimeStep, w, x, y, z) {
...
Pulley3.prototype.updateInitialParameters = function () {

//Level: Pendulum
var CirclePendulum5 = function () {
    this.maxDuration = 0.725;
};

CirclePendulum5.prototype.setNiceViewCenter = function (gameGraphics, canvas) {
    var point = { x: -0.01, y: 0.25 };
    gameGraphics.PTM = 580;
    setViewCenterWorld(gameGraphics, canvas, point, true);
}

CirclePendulum5.prototype.setup = function (gameState, gameGraphics) {
    ...
    */
    ...
    var angle_deg1 = 270 - 30;
    var angle_deg2 = 270 + 30;
    ...
    shape1.setElasticity(Math.sqrt(0.7));
    ...
    shape2.setElasticity(Math.sqrt(0.7));
...
CirclePendulum5.prototype.step = function (gameState, gameDygraph, dataTimeStep, graphTimeStep) {
...
CirclePendulum5.prototype.initializeDygraph = function (gameState, gameDygraph, graphID) {
...
CirclePendulum5.prototype.updateCurrentParameters = function (t1, h1, h2) {
...
CirclePendulum5.prototype.addToDygraph = function (gameState, gameDygraph, dataTimeStep, graphTimeStep, x, y) {
...
CirclePendulum5.prototype.updateInitialParameters = function () {
    ...
    table.innerHTML =
        ...
        '<tr class=\'pendulum-1-init\'>' +
        '<td>Angle</td>' +
        '<td id="angle-initial-1">30 deg</td>' +
        '</tr>' +

        '<tr class=\'pendulum-1-init\'>' +
        '<td>Height</td>' +
        '<td id="height-initial-1">6.7 cm</td>' +
        '</tr>' +
        ...
        '<tr class=\'pendulum-2-init\'>' +
        '<td>Angle</td>' +
        '<td id="angle-initial-2">-30 deg</td>' +
        '</tr>' +

        '<tr class=\'pendulum-2-init\'>' +
        '<td>Height</td>' +
        '<td id="height-initial-2">6.7 cm</td>' +
        '</tr>' +

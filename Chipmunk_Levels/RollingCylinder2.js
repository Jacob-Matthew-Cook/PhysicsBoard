var RollingCylinder2 = function () {
    this.maxDuration = 2;
};

RollingCylinder2.prototype.setNiceViewCenter = function (gameGraphics, canvas) {
    gameGraphics.PTM = 500;
    var center = {x: 0.67, y: 0.25}
    setViewCenterWorld(gameGraphics, canvas, center, true);
}

RollingCylinder2.prototype.setup = function (gameState, gameGraphics) {
    ...
    var st_pt2 = cp.v(0.2, h + 0.2 - 0.025);

    var body1 = world.addBody(new cp.Body(mass1, cp.momentForCircle(mass1, 0, radOuter, zr_pt)));
    body1.setPos(st_pt1);
    body1.setAngle(0);
    ...
    var body2 = world.addBody(new cp.Body(mass2, cp.momentForCircle(mass2, 0, 0.5 * radOuter, zr_pt)));
    body2.setPos(st_pt2);
    body2.setAngle(0);

    var shape2 = gameState.shapeArray[1] = world.addShape(new cp.CircleShape(body2, 0.5 * radOuter, zr_pt));
...
RollingCylinder2.prototype.step = function (gameState, gameDygraph, dataTimeStep, graphTimeStep) {
    if (this.block) {
        gameState.world.removeShape(this.block);
        this.block = null;
    }
...
RollingCylinder2.prototype.initializeDygraph = function (gameState, gameDygraph, graphID) {
...
RollingCylinder2.prototype.updateCurrentParameters = function (t1, w, x, y, z) {
...
RollingCylinder2.prototype.addToDygraph = function (gameState, gameDygraph, dataTimeStep, graphTimeStep, w, x, y, z) {
...
RollingCylinder2.prototype.updateInitialParameters = function () {

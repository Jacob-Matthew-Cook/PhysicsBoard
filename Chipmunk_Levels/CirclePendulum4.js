//Level: Pendulum
var CirclePendulum4 = function () {
    this.maxDuration = 0.710;
};

CirclePendulum4.prototype.setNiceViewCenter = function (gameGraphics, canvas) {
    var point = { x: -0.01, y: 0.25 };
    gameGraphics.PTM = 580;
    setViewCenterWorld(gameGraphics, canvas, point, true);
}

CirclePendulum4.prototype.setup = function (gameState, gameGraphics) {
...
CirclePendulum4.prototype.step = function (gameState, gameDygraph, dataTimeStep, graphTimeStep) {
...
CirclePendulum4.prototype.initializeDygraph = function (gameState, gameDygraph, graphID) {
...
CirclePendulum4.prototype.updateCurrentParameters = function (t1, h1, h2) {
...
CirclePendulum4.prototype.addToDygraph = function (gameState, gameDygraph, dataTimeStep, graphTimeStep, x, y) {
...
CirclePendulum4.prototype.updateInitialParameters = function () {

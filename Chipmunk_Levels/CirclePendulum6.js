//Level: Pendulum
var CirclePendulum6 = function () {
    this.maxDuration = 0.76;
};

CirclePendulum6.prototype.setNiceViewCenter = function (gameGraphics, canvas) {
    var point = { x: -0.01, y: 0.25 };
    gameGraphics.PTM = 580;
    setViewCenterWorld(gameGraphics, canvas, point, true);
}

CirclePendulum6.prototype.setup = function (gameState, gameGraphics) {
...
CirclePendulum6.prototype.step = function (gameState, gameDygraph, dataTimeStep, graphTimeStep) {
...
CirclePendulum6.prototype.initializeDygraph = function (gameState, gameDygraph, graphID) {
...
CirclePendulum6.prototype.updateCurrentParameters = function (t1, h1, h2) {
...
CirclePendulum6.prototype.addToDygraph = function (gameState, gameDygraph, dataTimeStep, graphTimeStep, x, y) {
...
CirclePendulum6.prototype.updateInitialParameters = function () {

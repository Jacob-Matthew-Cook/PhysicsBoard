var RollingCylinder3 = function () {
    this.maxDuration = 2;
};

RollingCylinder3.prototype.setNiceViewCenter = function (gameGraphics, canvas) {
    gameGraphics.PTM = 500;
    var center = {x: 0.67, y: 0.25}
    setViewCenterWorld(gameGraphics, canvas, center, true);
}

RollingCylinder3.prototype.setup = function (gameState, gameGraphics) {
    ...
    var body2 = world.addBody(new cp.Body(mass2, cp.momentForCircle(mass2, 0.5 * radInner, 0.5 * radOuter, zr_pt)));
    body2.setPos(st_pt2);
    body2.setAngle(0);
...
RollingCylinder3.prototype.step = function (gameState, gameDygraph, dataTimeStep, graphTimeStep) {
...
RollingCylinder3.prototype.initializeDygraph = function (gameState, gameDygraph, graphID) {
...
RollingCylinder3.prototype.updateCurrentParameters = function (t1, w, x, y, z) {
...
RollingCylinder3.prototype.addToDygraph = function (gameState, gameDygraph, dataTimeStep, graphTimeStep, w, x, y, z) {
...
RollingCylinder3.prototype.updateInitialParameters = function () {
